<template>
    <div class="pomodoro-container">
        ...
        <div class="range-container">
                ...
                <input v-model="work" :disabled="isTimerRunning || isRestRunning"
                     type="range" name="work" min="15" max="60">
           
                <label for="rest">Rest: {{ rest }}min</label>
                <input v-model="rest" :disabled="isTimerRunning || isRestRunning"
                     type="range" name="rest" min="5" max="25">
        </div>
...
<style scoped>
    ...
    .timer-container, .range-container {
        display: flex;
